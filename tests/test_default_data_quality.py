...
@pytest.mark.parametrize(
    ...
    [
        ...
        (DataInValuesValidatorPandasSeries, [0, 1], pd.Series([0, 1, 1]), True),
        (
            DataInValuesValidatorPandasSeries,
            [0.0, 1.0],
        ...
        (DataInValuesValidatorPandasSeries, [0], pd.Series([0, 1, 1]), False),
        (
            DataInValuesValidatorPandasSeries,
            [0.0],
            pd.Series([0.0, 1.0, 1.0]),
        ...
        (AllowNaNsValidatorPandasSeries, False, pd.Series([0.1, None]), False),
        (AllowNaNsValidatorPandasSeries, False, pd.Series([0.1, 0.2]), True),
